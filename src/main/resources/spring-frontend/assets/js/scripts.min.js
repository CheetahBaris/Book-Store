                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                // sendData('/books/recommended/page/'+ $this.data('refreshquery'), {
                                                // offset: function () {
                                                //
                                                //     var oldOffset = $this.data('refreshoffset');
                                                //         if(oldOffset < 1){
                                            ...
                                            case'recent':
                                                ...
                                                // ssendData('/books/recent/page/'+ $this.data('refreshquery'), {
                                                //     offset: function () {
                                                //
                                                //         var oldOffset = $this.data('refreshoffset');
                                                //         if(oldOffset < 1){
                                            ...
                                            case'popular':
                                                ...
                                                // sendData('/books/popular/page/'+ $this.data('refreshquery'), {
                                                //     offset: function () {
                                                //
                                                //         var oldOffset = $this.data('refreshoffset');
                                                //         if(oldOffset < 1){
