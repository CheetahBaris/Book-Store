                        ...
                        function reloadDate() {
                            ...
                            if ($window.width() > 990) {
                                ...
                                $dateInputs.filter('[name="fromdaterecent"]').each(function () {
                                    var $this = $(this);
                                    today.setMonth(today.getMonth() - 264);
                                    $this.datepicker().data('datepicker').update({maxDate: new Date()}).selectDate(today);
                                });
                            } else {
                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            };getData('/search/page/' + $this.find('.search-input').val() + $(0).data('refreshoffset') + $(5).data('refreshoffset'),{
                                offset: function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="'+/books/+book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.discount ? '<div class="Card-sale">' + Math.floor(book.discount*100).valueOf()  + '% скидка</div>' : '') +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/books/page/genres?'+ 'genre=' + $('[data-genre]').data('genre'), {
                                    offset: function (){
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset<1){
                                            $this.data('refreshoffset', oldOffset++);
                                ...
                                break;
                            case'author':
                                getData('/books/page/authors?'+ 'author=' +$('[data-author]').data('author'), {
                                    offset: function (){
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset<1){
                                            $this.data('refreshoffset', oldOffset++);
                                ...
                                break;
                            case'tag':
                                getData('/books/page/tags' +'?tag='+ $('[data-tag]').data('tag'), {
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        data.bookId = $('[data-bookid]').data('bookid');
                                ...
                                postData('/requestContactConfirmation', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        switch ($this.data('type')) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + (result != null ?  result.error : 'E-mail/Телефон не найден') + '</div>');
                                     }
                                })
                            }
                        }
                ...
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/changeBookStatus', {
                            book: $this.closest('.Rating').data('bookid'),
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/page/recentForSlider')
                                                break;
                                            case'popular':
                                                sendData('/books/page/popular')
                                                break;
                                            case'author':
                                                sendData('/books/page/authors?'+ 'author=' +$('[data-author]').data('author'))
                                                break;
                                        }
                                    }
                                }
